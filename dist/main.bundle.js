...
var _ProductListComponent = __webpack_require__(28);

var _ProductListComponent2 = _interopRequireDefault(_ProductListComponent);

var _FilterComponent = __webpack_require__(32);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'header',
                    null,
                    _react2.default.createElement('img', { src: 'https://classes.codingbootcamp.cz/assets/classes/workouts/aperture.png', alt: 'Aperture science', className: 'logo' }),
                    _react2.default.createElement(
                        'div',
                        { className: 'user' },
                        _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_ProductListComponent2.default, null)
                    )
                ),
                _react2.default.createElement(
                    'footer',
                    null,
                    '\xA9 2027 Aperture Laboratories'
                )
            );
        }
    }]);
...
var _ProductComponent = __webpack_require__(29);
...
var ProductList = function (_React$Component) {
    ...
    _createClass(ProductList, [{
        key: 'setNrOfProducts',
        value: function setNrOfProducts(nr) {
            this.setState({
                nr_of_products: nr
            });
        }
        ...
        value: function render() {
            ...
            var data = [{ src: 'propulsion-gel.jpg', name: 'Propulsion gel' }, { src: 'weight-cube.jpg', name: 'Weight cub' }, { src: 'friendly-cube.jpg', name: 'A friend' }, { src: 'portal-gun.jpg', name: 'Portal gun' }, { src: 'defense-robot.jpg', name: 'Home-defense robot' }, { src: 'cake.jpg', name: 'Cake (not a lie)' }];

            this.products = [];

            for (var i in data) {

                var product = _react2.default.createElement(_ProductComponent2.default, { key: data[i].src, imageSrc: data[i].src, name: data[i].name });

                this.products[i] = product;

                if (this.products.length >= this.state.nr_of_products) {
                    break;
                }
            }
...
var Product = function (_React$Component) {
    ...
    function Product(props) {
        ...
        return _possibleConstructorReturn(this, (Product.__proto__ || Object.getPrototypeOf(Product)).call(this, props)); //call the constructor of React.Component
    }
    ...
    _createClass(Product, [{
        ...
        value: function render() {
            ...
            var image_path = 'https://classes.codingbootcamp.cz/assets/classes/workouts/aperture/';
            var src = image_path + this.props.imageSrc;
...
var Filter = function (_React$Component) {
    ...
    _createClass(Filter, [{
        ...
        value: function inputValueChanged(elem) {
            this.setState({
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', name: 'filter', id: 'filter',
                    value: this.state.input_value,
                    onChange: function onChange(elem) {
                        _this2.inputValueChanged(elem);
                    },
